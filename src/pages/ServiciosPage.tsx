...
const PAYMENT_LINKS: Record<string, string> = {
  ...
  // PRUEBA a S/2 (pref con auto_return). Volver a S/49 (pref 7e12e802) al terminar.
  finanstart:
    'https://www.mercadopago.com.pe/checkout/v1/redirect?pref_id=3410303242-67918903-e8e9-43ab-a5a8-0ef2134f9aed',
